...
- The 3 kW/36 V frozen parents impose an **83.33 A propulsion-only continuous pack-current lower bound**; final continuous current follows TR-067. TR-069 now inventories the only presently numeric repository-backed passive auxiliary subtotal but does not close `P_aux,pack`.
