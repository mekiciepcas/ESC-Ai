...
- **TR-054 / G0 closure interface:** `G0_USER_INPUT_FORM.md` presents the 14 unresolved product-specific G0 fields in a compact user-facing form. The form does not supply defaults or competitor substitutions; derived MTOW/rotor/battery/ESC values remain blocked until actual inputs are provided.

Observed CI evidence for TR-052: GitHub Actions run `35448141446`, job `105910551415`, completed successfully. Checker output: `PASS`, `registered_component_bearing_revisions=0`, `next_component_bearing_revision=U1-SCH-R001`, `changed_files_checked=1`.
