...
lib=root/'ESC_B1.pretty';lib.mkdir(exist_ok=True)
...
(root/'fp-lib-table').write_text('(fp_lib_table (lib (name "ESC_B1") (type "KiCad") (uri "${KIPRJMOD}/ESC_B1.pretty") (options "") (descr "Local engineering footprints")))',encoding='utf-8')
